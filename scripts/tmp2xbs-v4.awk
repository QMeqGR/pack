...
(NR==3){num_typ_an=$1;}
(NR==4){num_vert_1=$1; n_an_1=$2;}
(NR==5){q_an_c_1=$1; q_an_v_1=$2;}
(NR==6){d_1=$1; Rc_1=$2; Rv_1=$3; Zcent_1=$4; Zvert_1=$5;}
(NR==7){n_type_ca=$1;}
(NR==8){n_ca_1=$1; q_ca_1=$2;}
(NR==9){R_cation_1=$1; Z_cation_1=$2;}
(NR==10 && n_type_ca==2 ){n_ca_2=$1; q_ca_2=$2;}
(NR==11 && n_type_ca==2 ){R_cation_2=$1; Z_cation_2=$2;}
(n_type_ca==1 && NR>9){
  r[3*count+0] = $1;
  r[3*count+1] = $2;
  r[3*count+2] = $3;
...
# print cations first
  ...
  k=3*n_ca_1+3*n_ca_2;
  for(i=0; i<n_an_1; i++){
    for(j=0;j<num_vert_1;j++){
      K=k+i*num_vert_1*3+3*j;
